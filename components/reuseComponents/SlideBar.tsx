...
const SlideBar: React.FC<SliderProps> = ({
  ...
  const [value, setValue] = useState(
    Math.min(Math.max(initialValue, minimumValue), maximumValue)
  );
  ...
  return (
    <View style={styles.container}>
      ...
      <Slider
        ...
        minimumTrackTintColor="#3EB8AF"  // Màu xanh theo yêu cầu
...
const styles = StyleSheet.create({
  ...
  thumb: {
    ...
    borderRadius: 20,
    borderWidth: 2,
    borderColor: "#3EB8AF",  // Đổi viền màu xanh
    shadowColor: "#000",
  ...
  valueBox: {
    ...
    borderWidth: 1,
    borderColor: "#3EB8AF",
    paddingVertical: 2, // Thu nhỏ chiều cao
    paddingHorizontal: 8, // Thu nhỏ chiều rộng
    minWidth: 40, // Đảm bảo vừa khít số
    alignItems: "center",
    justifyContent: "center",
  },  
  value: {
